...
namespace Lachesis.QuantumComputing
{
	public class QuantumRegister
	{
		...
		public QuantumRegister(Vector<Complex> vector)
		{
			...
			{
                throw new ArgumentException("Квантовый регистр может быть инициализирован только из вектора, размерность которого равна 2");
//              throw new ArgumentException("A quantum register can only be initialized from a vector whose dimension is a power of 2.");
        ...
        public static QuantumRegister DadaRegistr(int length)
        {
            ...
            return new QuantumRegister(vector);
        }
        /*
		 * Generalized W state
		 */
